...
```bash
cd src
python3 evaluation.py --n-samples 100 --strategy zero_shot
```

**4. Compare all 4 strategies**
```bash
cd src
python3 prompt_comparison.py --n-samples 100
```

**5. Cost analysis**
```bash
cd src
python3 cost_analysis.py --run-sample 10 --strategy zero_shot
```
